...
function Marquee_comp() {
  return (
    <div className='marquee-section'>
        <div id='title' style={{display: "flex", justifyContent: "center", fontSize:'40px'}}>Our Suppliers</div>
        <marquee direction="left" width="100%" height="150px" scrollamount='20' className='partners'>
            ...
            <img className='marquee-elem' style={{width:'500px', height:'80px'}} src='https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Flogonoid.com%2Fimages%2Fdenso-logo.png&f=1&nofb=1&ipt=ab893c78e1b61f0ca8920973f566c1365db3c9f02daa1aec217162c54b516f86&ipo=images'/>
